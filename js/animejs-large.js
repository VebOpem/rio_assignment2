export function animejsLarge () {
    ...
    .add({
        targets: '#p6-img',
        keyframes: [
            {translateX: 150, translateY: -300, opacity: 0, duration: 0},
    ...
    .add({
        targets: '#p9-img',
        keyframes: [
            {translateX: 125, translateY: 1000, duration: 0},
            {translateX: 0, translateY: 0, duration: 17},
            {translateX: 0, translateY: -1000, duration: 5}
        ],
        easing: 'linear',
    ...
    .add({
        ...
        keyframes: [
            ...
            {translateX: 50, translateY: 0, opacity: 1, duration: 20},
            {opacity: 0, duration: 3},
        ],
        easing: 'linear',
